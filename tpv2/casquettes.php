...
$triJson = file_get_contents("data/tri-casquettes.json");
$triCasquettes = json_decode($triJson, true);
...
foreach ($triCasquettes as $codeOptions => $detailOptions) {
...
$tsJson = file_get_contents("data/casquettes.json");
$casquettes = json_decode($tsJson, true);
...
foreach ($casquettes as $codeCat => $detailCat) {
	// Langue par défaut dans le catalogue
	$langueCat = "fr";
...
<main class="page-produits page-casquettes">
	<article class="amorce">
		...
		<section class="controle">
			<div class="filtre">
				<form action="casquettes.php" method="get" id="formulaire">
					...
					<script>
						let formulaireCasquettes = document.getElementById("formulaireCasquettes");
